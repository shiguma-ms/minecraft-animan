...
- 前提
    - Fabric 1.17.1
        ...
        - http://mechakurahome.com/2021/07/08/1-17-fabric/
...
- あると便利MOD
    - ModMenu
        - Modの設定をマイクラ側から変更できるようになる
        - https://media.forgecdn.net/files/3472/548/modmenu-2.0.13.jar
    - Lithium
        - 全般処理改善Mod
        - https://media.forgecdn.net/files/3438/799/lithium-fabric-mc1.17.1-0.7.4.jar
    - Sodium
        - 描画処理改善Mod。リンク先の～.jarをDL
        - https://github.com/CaffeineMC/sodium-fabric/releases/tag/mc1.17.1-0.3.2
    - Inventory Profiles Next
        - インベントリに整列(ソート)ボタンなどを追加する
        - https://media.forgecdn.net/files/3477/726/InventoryProfilesNext-fabric-1.17-1.0.3.jar
    - VoxelMap
        - 画面上に周囲マップを描画する
        - https://media.forgecdn.net/files/3345/206/fabricmod_VoxelMap-1.10.15_for_1.17.0.jar
    - Diggus Maximus
        - 一括破壊系。初期状態だと何でも一括破壊するので要設定
        - https://media.forgecdn.net/files/3475/174/diggusmaximus-1.5.0-1.17.jar
- その他のMod
    - 未検証
...
![MODダウンロード手順](doc/images/mod_download.png)
...
![DiggusMaximus設定1](doc/images/dm_config_1.png)
...
![DiggusMaximus設定1](doc/images/dm_config_2.png)
